...
class BMSClientTests: XCTestCase {
    ...
    func testInitialization() {
        ...
        clientInstance.initializeWithBluemixAppRoute("http://example.com", bluemixAppGUID: "1234", bluemixRegionSuffix: BMSClient.REGION_US_SOUTH)
        XCTAssertEqual(clientInstance.bluemixAppRoute, "http://example.com")
        XCTAssertEqual(clientInstance.bluemixAppGUID, "1234")
        XCTAssertEqual(clientInstance.bluemixRegionSuffix, BMSClient.REGION_US_SOUTH)
